...
let Api_url="https://generativelanguage.googleapis.com/v1beta/models/gemini-flash-latest:generateContent?key=AIzaSyDhbgHH47MRUJY9lYS2p3dx6fdgdR69wcc";
...
function takeCommand(message ){
    if(message.includes("open") && message.includes("chat")){
        ...
        speak("okay baby")
        window.open("http://127.0.0.1:5500/biceps.html","_self")
    }
        ...
        speak("hello baby ,how can i help you")
    }
    else if(message.includes("who are you")){
        speak("i am a virtual assistant, created by Shivani dubey")
    }
